...
func RegisterDefaults(scheme *runtime.Scheme) error {
	scheme.AddTypeDefaultingFunc(&Xdaemonset{}, func(obj interface{}) { SetObjectDefaults_xdaemonset(obj.(*Xdaemonset)) })
	return nil
}


func SetObjectDefaults_xdaemonset(in *Xdaemonset) {
	SetDefaultsXdaemonset(in)
